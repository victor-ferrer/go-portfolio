...
// Optional: DB_SSLMODE (default: "disable"), MIGRATIONS_PATH (default: "file://./infrastructure/database/migrations").
func Load() (*Config, error) {
	...
	if cfg.MigrationsPath == "" {
		cfg.MigrationsPath = "file://./infrastructure/database/migrations"
	}
